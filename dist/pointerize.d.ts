...
interface IOptionsShapeAnimation extends Omit<ICssAnimation, 'css_properties'> {
    /**
     * A preset that can be used instead of specifying the options.
     * The accepted value will be changed; please refer to `CHANGELOG.md`.
     */
...
declare type TPutPropsInArray<Type> = {
    [Property in keyof Type]: Type[Property][];
};
declare type TOptionsShapeMakeMulti = TPutPropsInArray<IOptionsShape>;
